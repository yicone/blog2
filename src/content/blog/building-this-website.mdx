...
- **[UnoCSS](https://unocss.dev/):** The instant on-demand atomic CSS engine. The project was already using it, but I upgraded it to the latest version to ensure better compatibility and performance.
- **[DaisyUI](https://daisyui.com/):** A component library for Tailwind CSS. I standardized the theme configuration and upgraded to the latest version to leverage new components.
