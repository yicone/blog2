...
- [jukaLang/Juka](https://github.com/jukaLang/Juka) - 🥣 Juka Programming Language - Fast Portable Programming Language. Run code anywhere without complicated installations and admin rights. Simple, yet powerful new programming language [Easy to code and 
- [ks32/CrosswalkNative](https://github.com/ks32/CrosswalkNative) - Embedded Crosswalk 77 webview based sample project.
...
- [lampaa/com.lampa.startapp](https://github.com/lampaa/com.lampa.startapp) - Phonegap plugin for check or launch other application in android device.
...
- [pradeep1991singh/cordova-plugin-secure-key-store](https://github.com/pradeep1991singh/cordova-plugin-secure-key-store) - Cordova plugin for securely saving keys, passwords or strings on devices.
...
- [tiann/super-adb](https://github.com/tiann/super-adb) - Enhance the adb shell using busybox, supporting vi、grep and awk etc. No need root.
...
- [pscj/ModularizationArchitecture](https://github.com/pscj/ModularizationArchitecture) - Android 组件化示例 (单进程精简版)
...
- [zhanghai/PatternLock](https://github.com/zhanghai/PatternLock) - Material Design Pattern Lock with auth flow implementation
- [wasabeef/awesome-android-ui](https://github.com/wasabeef/awesome-android-ui) - A curated list of awesome Android UI/UX libraries
- [wdullaer/SwipeActionAdapter](https://github.com/wdullaer/SwipeActionAdapter) - The Mailbox-like Swipe gesture library for Android
...
- [kamilkisiela/apollo-angular](https://github.com/kamilkisiela/apollo-angular) - A fully-featured, production ready caching GraphQL client for Angular and every GraphQL server 🎁
- [dotansimha/graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) - A tool for generating code based on a GraphQL schema and GraphQL operations (query/mutation/subscription), with flexible support for custom plugins.
...
- [geerlingguy/ansible-role-firewall](https://github.com/geerlingguy/ansible-role-firewall) - Ansible Role - iptables Firewall configuration.
...
- [netlify/js-client](https://github.com/netlify/js-client) - A Open-API derived JS + Node.js API client for Netlify
...
- [willin/waliyun](https://github.com/willin/waliyun) - 阿里云Node.js Open API SDK（完整版）
...
- [form-o-fill/form-o-fill-chrome-extension](https://github.com/form-o-fill/form-o-fill-chrome-extension) - The programmable form filler for developers. Powered by javascript.
...
- [nsmithuk/local-kms](https://github.com/nsmithuk/local-kms) - A mock version of AWS' Key Management Service, for local development and testing.
...
- [themelizeme/appstrap-docs](https://github.com/themelizeme/appstrap-docs) - AppStrap Bootstrap 4 Theme Documentation
- [react-bootstrap/react-bootstrap](https://github.com/react-bootstrap/react-bootstrap) - Bootstrap components built with React

## bot 

- [Taosky/telegram-search-bot](https://github.com/Taosky/telegram-search-bot) - Telegram中文聊天记录搜索机器人
...
- [UseGPT/ChatGPT-SaaS](https://github.com/UseGPT/ChatGPT-SaaS) - 完善的多用户 ChatGPT 付费前后端
...
- [NdYAG/ANNO](https://github.com/NdYAG/ANNO) - 📗 豆瓣读书笔记第三方客户端
...
- [fliphub/fliplog](https://github.com/fliphub/fliplog) - fluent logging with verbose insight, colors, tables, emoji, filtering, spinners, progress bars, timestamps, capturing, stack traces, tracking, presets, & more...
...
- [merkle-open/webpack-config-plugins](https://github.com/merkle-open/webpack-config-plugins) - Provide best practices for webpack 4 loader configurations
...
- [jogetworkflow/jw-community](https://github.com/jogetworkflow/jw-community) - Joget is an open source no-code/low-code application platform that combines the best of rapid application development, business process automation and workflow management. This Joget open source repos
- [astrit/css.gg](https://github.com/astrit/css.gg) - 700+ Pure CSS, SVG, PNG & Figma UI Icons Available in SVG Sprite, styled-components, NPM & API and 6000 glyphs
...
- [asad70/wallstreetbets-sentiment-analysis](https://github.com/asad70/wallstreetbets-sentiment-analysis) - This program finds the most mentioned ticker on r/wallstreetbets and uses Vader SentimentIntensityAnalyzer to calculate the sentiment analysis.
- [SheetJS/sheetjs](https://github.com/SheetJS/sheetjs) - 📗 SheetJS Spreadsheet Data Toolkit -- New home https://git.sheetjs.com/SheetJS/sheetjs
...
- [NannyML/nannyml](https://github.com/NannyML/nannyml) - nannyml: post-deployment data science in python
- [dair-ai/ML-Course-Notes](https://github.com/dair-ai/ML-Course-Notes) - 🎓 Sharing machine learning course / lecture notes.
- [mikekeith52/scalecast](https://github.com/mikekeith52/scalecast) - The practitioner's forecasting library
- [apache/superset](https://github.com/apache/superset) - Apache Superset is a Data Visualization and Data Exploration Platform
...
- [mgramin/awesome-db-tools](https://github.com/mgramin/awesome-db-tools) - Everything that makes working with databases easier
- [goldmansachs/obevo](https://github.com/goldmansachs/obevo) - Obevo is a database deployment tool that handles enterprise scale schemas and complexity
...
- [fauna-labs/faunadb-importer](https://github.com/fauna-labs/faunadb-importer) - Importer tool to load data into FaunaDB
...
- [axetroy/swagger2ts](https://github.com/axetroy/swagger2ts) - 💗 从 Swagger 生成优雅的 Typescript 代码. Generate elegant typescript code from swagger.
- [kysely-org/kysely](https://github.com/kysely-org/kysely) - A type-safe typescript SQL query builder
...
- [yezz123/FRDP](https://github.com/yezz123/FRDP) - Boilerplate code for quick docker implementation of REST API with JWT Authentication using FastAPI, PostgreSQL and PgAdmin ⭐
- [Lissy93/dashy](https://github.com/Lissy93/dashy) - 🚀 A self-hostable personal dashboard built for you. Includes status-checking, widgets, themes, icon packs, a UI editor and tons more!
...
- [wechaty/docker-getting-started](https://github.com/wechaty/docker-getting-started) - Getting Started Template for Docker Users
...
- [gotenberg/gotenberg](https://github.com/gotenberg/gotenberg) - A developer-friendly API for converting numerous document formats into PDF files, and more!
- [jenkinsci/docker-workflow-plugin](https://github.com/jenkinsci/docker-workflow-plugin) - Jenkins plugin which allows building, testing, and using Docker images from Jenkins Pipeline projects.
- [n8n-io/n8n](https://github.com/n8n-io/n8n) - Free and source-available fair-code licensed workflow automation tool. Easily automate tasks across different services.
...
- [tmaier/docker-compose](https://github.com/tmaier/docker-compose) - Container with Docker + Docker Compose - good for CI
- [netdata/netdata](https://github.com/netdata/netdata) - Monitor your servers, containers, and applications, in high-resolution and in real-time!
- [wsargent/docker-cheat-sheet](https://github.com/wsargent/docker-cheat-sheet) - Docker Cheat Sheet
- [krallin/tini](https://github.com/krallin/tini) - A tiny but valid `init` for containers
- [remind101/empire](https://github.com/remind101/empire) - A PaaS built on top of Amazon EC2 Container Service (ECS)
- [Kong/kong](https://github.com/Kong/kong) - 🦍 The Cloud-Native API Gateway
- [arunvelsriram/docker-time-sync-agent](https://github.com/arunvelsriram/docker-time-sync-agent) - docker-time-sync-agent is a tool to prevent time drift in Docker for Mac's HyperKit VM.
- [hexsum/Mojo-Weixin](https://github.com/hexsum/Mojo-Weixin) - 使用Perl语言（不会没关系）编写的个人账号微信/weixin/wechat客户端框架（非GUI），可通过插件提供基于HTTP协议的api接口供其他语言或系统调用
...
- [Blazity/next-enterprise](https://github.com/Blazity/next-enterprise) - 💼 An enterprise-grade Next.js boilerplate for high-performance, maintainable apps. Packed with features like Tailwind CSS, TypeScript, ESLint, Prettier, testing tools, and more to accelerate your deve
- [Vonubat/rs-lang](https://github.com/Vonubat/rs-lang) - RS Lang - App for Learning English
...
- [jina-ai/jina](https://github.com/jina-ai/jina) - 🔮 Multimodal AI services & pipelines with cloud-native stack: gRPC, Kubernetes, Docker, OpenTelemetry, Prometheus, Jaeger, etc.
- [caviarjs/caviar](https://github.com/caviarjs/caviar) - The skeleton of frameworks for micro frontends
...
- [gitex-flow/gitex-flow-node](https://github.com/gitex-flow/gitex-flow-node) - A git flow extension that provides some additional automation and feature improvements. The goal of the project is to offer a complete process chain in order to organize the releases of your projects 
...
- [a8m/tree](https://github.com/a8m/tree) - An implementation of the Unix tree command written in Go, that can be used programmatically
- [zeromicro/go-zero](https://github.com/zeromicro/go-zero) - A cloud-native Go microservices framework with cli tool for productivity.
- [goadesign/goa](https://github.com/goadesign/goa) - Design-based APIs and microservices in Go
...
- [dgraph-io/dgraph](https://github.com/dgraph-io/dgraph) - The high-performance database for modern applications
- [megaease/easeprobe](https://github.com/megaease/easeprobe) - A simple, standalone, and lightweight tool that can do health/status checking, written in Go.
- [ysmood/got](https://github.com/ysmood/got) - An enjoyable golang test framework.
- [kovidgoyal/kitty](https://github.com/kovidgoyal/kitty) - Cross-platform, fast, feature-rich, GPU based terminal
- [JanDeDobbeleer/oh-my-posh](https://github.com/JanDeDobbeleer/oh-my-posh) - The most customisable and low-latency cross platform/shell prompt renderer
- [IBAX-io/go-ibax](https://github.com/IBAX-io/go-ibax) - An innovative Blockchain Protocol Platform, which everyone can deploy their own applications quickly and easily, such as Dapp, DeFi, DAO, Cross-Blockchain transactions, etc.
- [doocs/leetcode](https://github.com/doocs/leetcode) - 😏 LeetCode solutions in any programming language | 多种编程语言实现 LeetCode、《剑指 Offer（第 2 版）》、《程序员面试金典（第 6 版）》题解
...
- [spockframework/spock-example](https://github.com/spockframework/spock-example) - Spock example specifications along with ready-to-go Gradle and Maven builds
...
- [prisma-labs/graphql-prisma-typescript](https://github.com/prisma-labs/graphql-prisma-typescript) - 🏡  GraphQL server reference implementation (Airbnb clone) in Typescript using Prisma & graphql-yoga
- [apollographql/apollo-server](https://github.com/apollographql/apollo-server) - 🌍  Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
- [dotansimha/graphql-yoga](https://github.com/dotansimha/graphql-yoga) - 🧘 Rewrite of a fully-featured GraphQL Server with focus on easy setup, performance & great developer experience.  The core of Yoga implements WHATWG Fetch API and can run/deploy on any JS environment.
- [graphql-nexus/nexus](https://github.com/graphql-nexus/nexus) - Code-First, Type-Safe, GraphQL Schema Construction
- [MichalLytek/type-graphql](https://github.com/MichalLytek/type-graphql) - Create GraphQL schema and resolvers with TypeScript, using classes and decorators!
- [kobylynskyi/graphql-java-codegen](https://github.com/kobylynskyi/graphql-java-codegen) - Make your GraphQL Java application schema-driven.
- [dotansimha/graphql-code-generator](https://github.com/dotansimha/graphql-code-generator) - A tool for generating code based on a GraphQL schema and GraphQL operations (query/mutation/subscription), with flexible support for custom plugins.
...
- [yarinvak/graphql-spring-annotations](https://github.com/yarinvak/graphql-spring-annotations) - a starter for a graphql-java-annotations in spring
...
- [ddliu/gulp-remote-src](https://github.com/ddliu/gulp-remote-src) - Remote gulp.src
...
- [pyjanitor-devs/pyjanitor](https://github.com/pyjanitor-devs/pyjanitor) - Clean APIs for data cleaning. Python implementation of R package Janitor
- [DP6/Marketing-Attribution-Models](https://github.com/DP6/Marketing-Attribution-Models) - Python Class created to address problems regarding Digital Marketing Attribution.
- [mindsdb/mindsdb](https://github.com/mindsdb/mindsdb) - MindsDB connects AI models to databases.
- [ing-bank/popmon](https://github.com/ing-bank/popmon) - Monitor the stability of a Pandas or Spark dataframe ⚙︎
- [Lissy93/dashy](https://github.com/Lissy93/dashy) - 🚀 A self-hostable personal dashboard built for you. Includes status-checking, widgets, themes, icon packs, a UI editor and tons more!
...
- [kbrose/vsc-python-indent](https://github.com/kbrose/vsc-python-indent) - Correctly indent python code on the fly, in Visual Studio Code.
- [sherlock-project/sherlock](https://github.com/sherlock-project/sherlock) - 🔎 Hunt down social media accounts by username across social networks
...
- [dataplat/dbatools](https://github.com/dataplat/dbatools) - 🚀 SQL Server automation and instance migrations have never been safer, faster or freer
- [jenkinsci/folder-auth-plugin](https://github.com/jenkinsci/folder-auth-plugin) - Authorization Plugin for Jenkins that works on folders
...
- [http-builder-ng/http-builder-ng](https://github.com/http-builder-ng/http-builder-ng) - The easy HTTP client for Groovy (and Java).
...
- [timo-a/lomboker](https://github.com/timo-a/lomboker) - transform java files to lombok
- [raydac/netbeans-mmd-plugin](https://github.com/raydac/netbeans-mmd-plugin) - Free mind map editor with plug-ins for both NetBeans and Intellij
...
- [apache/plc4x](https://github.com/apache/plc4x) - PLC4X The Industrial IoT adapter
- [antkorwin/better-strings](https://github.com/antkorwin/better-strings) - Java String Interpolation Plugin
- [ray-project/ray](https://github.com/ray-project/ray) - Ray is a unified framework for scaling AI and Python applications. Ray consists of a core distributed runtime and a set of AI Libraries for accelerating ML workloads.
- [osohq/oso](https://github.com/osohq/oso) - Oso is a batteries-included framework for building authorization in your application.
- [goldmansachs/obevo](https://github.com/goldmansachs/obevo) - Obevo is a database deployment tool that handles enterprise scale schemas and complexity
- [flyway/flyway](https://github.com/flyway/flyway) - Flyway by Redgate • Database Migrations Made Easy.
...
- [jogetworkflow/jw-community](https://github.com/jogetworkflow/jw-community) - Joget is an open source no-code/low-code application platform that combines the best of rapid application development, business process automation and workflow management. This Joget open source repos
- [skyvers/skyve](https://github.com/skyvers/skyve) - Skyve is an open-source low-code platform that gives you access to all of the key capabilities needed to build sophisticated, robust and scalable cloud solutions.
- [openlowcode/Open-Lowcode](https://github.com/openlowcode/Open-Lowcode) - Solution for rapid development of specific enterprise software
- [atinfo/awesome-test-automation](https://github.com/atinfo/awesome-test-automation) - A curated list of awesome test automation frameworks, tools, libraries, and software for different programming languages. Sponsored by https://zapple.tech
...
- [eslint-functional/eslint-plugin-functional](https://github.com/eslint-functional/eslint-plugin-functional) - ESLint rules to disable mutation and promote fp in JavaScript and TypeScript.
- [pyscript/pyscript](https://github.com/pyscript/pyscript) - Home Page: https://pyscript.net  Examples: https://pyscript.net/examples
- [jribbens/verbose-regexp](https://github.com/jribbens/verbose-regexp) - Verbose Regular Expressions
- [GitHubDaily/GitHubDaily](https://github.com/GitHubDaily/GitHubDaily) - 坚持分享 GitHub 上高质量、有趣实用的开源技术教程、开发者工具、编程网站、技术资讯。A list cool, interesting projects of GitHub.
- [Leaflet/Leaflet](https://github.com/Leaflet/Leaflet) - 🍃 JavaScript library for mobile-friendly interactive maps 🇺🇦
- [atom/atom](https://github.com/atom/atom) - :atom: The hackable text editor
- [twbs/bootstrap](https://github.com/twbs/bootstrap) - The most popular HTML, CSS, and JavaScript framework for developing responsive, mobile first projects on the web.
...
- [mushan0x0/wxapp-api-interceptors](https://github.com/mushan0x0/wxapp-api-interceptors) - 微信小程序api拦截器
...
- [30-seconds/30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code) - Short code snippets for all your development needs
- [parcel-bundler/parcel](https://github.com/parcel-bundler/parcel) - The zero configuration build tool for the web. 📦🚀
- [thenativeweb/node-viewmodel](https://github.com/thenativeweb/node-viewmodel) - Node-viewmodel is a node.js module for multiple databases. It can be very useful if you work with (d)ddd, cqrs, eventdenormalizer, host, etc.
- [facebook/docusaurus](https://github.com/facebook/docusaurus) - Easy to maintain open source documentation websites.
...
- [Jianru-Lin/lambda-view](https://github.com/Jianru-Lin/lambda-view) - A New Tool for Reading JavaScript Code since 2017
- [discourse/discourse](https://github.com/discourse/discourse) - A platform for community discussion. Free, open, simple.
- [doubaokun/node-ab](https://github.com/doubaokun/node-ab) - A command tool to test the performance of HTTP services.
- [keeweb/keeweb](https://github.com/keeweb/keeweb) - Free cross-platform password manager compatible with KeePass
...
- [opengeos/leafmap](https://github.com/opengeos/leafmap) - A Python package for interactive mapping and geospatial analysis  with minimal coding in a Jupyter environment
- [n0vad3v/tg-chat-visual](https://github.com/n0vad3v/tg-chat-visual) - Telegram Chat History Visualization.
- [NannyML/nannyml](https://github.com/NannyML/nannyml) - nannyml: post-deployment data science in python
- [dongweiming/web_develop](https://github.com/dongweiming/web_develop) - 《Python Web开发实战》书中源码
- [nicohlr/ipychart](https://github.com/nicohlr/ipychart) - The power of Chart.js with Python
- [MLEveryday/100-Days-Of-ML-Code](https://github.com/MLEveryday/100-Days-Of-ML-Code) - 100-Days-Of-ML-Code中文版
...
- [apollographql/apollo-server](https://github.com/apollographql/apollo-server) - 🌍  Spec-compliant and production ready JavaScript GraphQL server that lets you develop in a schema-first way. Built for Express, Connect, Hapi, Koa, and more.
- [eggjs/egg](https://github.com/eggjs/egg) - 🥚 Born to build better enterprise frameworks and apps with Node.js & Koa
- [axetroy/kost](https://github.com/axetroy/kost) - 基于Koa，使用Typescript开发的Web框架
...
- [winterbe/java8-tutorial](https://github.com/winterbe/java8-tutorial) - Modern Java - A Guide to Java 8
- [dylanaraps/pure-bash-bible](https://github.com/dylanaraps/pure-bash-bible) - 📖 A collection of pure bash alternatives to external processes.
- [PacktPublishing/Node.js_Design_Patterns_Second_Edition_Code](https://github.com/PacktPublishing/Node.js_Design_Patterns_Second_Edition_Code) - Code repository for Node.js Design Patterns Second Edition, published by Packt
- [denysdovhan/wtfjs](https://github.com/denysdovhan/wtfjs) - 🤪 A list of funny and tricky JavaScript examples
...
- [xulihang/BasicCAT](https://github.com/xulihang/BasicCAT) - An open source computer-aided translation tool written in Basic

## lua 

- [jabbalaci/SpeedTests](https://github.com/jabbalaci/SpeedTests) - comparing the execution speeds of various programming languages
- [coolsnowwolf/lede](https://github.com/coolsnowwolf/lede) - Lean's LEDE source
- [withlin/kong-plugin-http-anti-replay-attack](https://github.com/withlin/kong-plugin-http-anti-replay-attack) - http-anti-replay-attack [防重放攻击]
- [neovim/neovim](https://github.com/neovim/neovim) - Vim-fork focused on extensibility and usability
...
- [onevcat/Kingfisher](https://github.com/onevcat/Kingfisher) - A lightweight, pure-Swift library for downloading and caching images from the web.
- [YacTeam/ohtipi](https://github.com/YacTeam/ohtipi) - iMessage AutoFill in any browser on macOS 🔐
...
- [markdown-it/markdown-it](https://github.com/markdown-it/markdown-it) - Markdown parser, done right. 100% CommonMark support, extensions, syntax plugins & high speed
- [markedjs/marked](https://github.com/markedjs/marked) - A markdown parser and compiler. Built for speed.
- [jaime-olivares/vscode-yuml](https://github.com/jaime-olivares/vscode-yuml) - yUML extension for Visual Studio Code
- [BoostIO/BoostNote-App](https://github.com/BoostIO/BoostNote-App) - Boost Note is a document driven project management tool that maximizes remote DevOps team velocity.
- [dotnet/docfx](https://github.com/dotnet/docfx) - Static site generator for .NET API documentation.
...
- [spockframework/spock-example](https://github.com/spockframework/spock-example) - Spock example specifications along with ready-to-go Gradle and Maven builds
- [microsoft/vscode-maven](https://github.com/microsoft/vscode-maven) - VSCode extension "Maven for Java"
- [apache/maven](https://github.com/apache/maven) - Apache Maven core
...
- [parse-community/parse-server](https://github.com/parse-community/parse-server) - Parse Server for Node.js / Express
- [meteor/meteor](https://github.com/meteor/meteor) - Meteor, the JavaScript App Platform
- [steedos/steedos-accounts](https://github.com/steedos/steedos-accounts) - 华炎魔方账户管理
- [reactioncommerce/example-storefront](https://github.com/reactioncommerce/example-storefront) - Example Storefront is Reaction Commerce’s headless ecommerce storefront - Next.js, GraphQL, React. Built using Apollo Client and the commerce-focused React UI components provided in the Storefront Com
- [reactioncommerce/reaction](https://github.com/reactioncommerce/reaction) - Mailchimp Open Commerce is an API-first, headless commerce platform built using Node.js, React, GraphQL. Deployed via Docker and Kubernetes.
...
- [liquibase/liquibase](https://github.com/liquibase/liquibase) - Main Liquibase Source
- [sunkaifei/FlyCms](https://github.com/sunkaifei/FlyCms) - FlyCms 是一个类似知乎以问答为基础的完全开源的JAVA语言开发的社交网络建站程序，基于 Spring Boot+Bootstrap3+MyBatis+MySql+Solr +Ehcache应用架构，专注于社区内容的整理、归类和检索，它集合了问答，digg，wiki 等多个程序的优点，帮助用户轻松搭建专业的知识库和在线问答社区。业务模块包括：权限管理，会员管理，角色管理，定时任务管理（调度管理
- [apache/shardingsphere](https://github.com/apache/shardingsphere) - Distributed SQL transaction & query engine for data sharding, scaling, encryption, and more - on any database.
- [prisma/prisma](https://github.com/prisma/prisma) - Next-generation ORM for Node.js & TypeScript | PostgreSQL, MySQL, MariaDB, SQL Server, SQLite, MongoDB and CockroachDB
- [compose/transporter](https://github.com/compose/transporter) - Sync data between persistence engines, like ETL only not stodgy
- [metabase/metabase](https://github.com/metabase/metabase) - The simplest, fastest way to get business intelligence and analytics to everyone in your company :yum:
...
- [PacktPublishing/Node.js_Design_Patterns_Second_Edition_Code](https://github.com/PacktPublishing/Node.js_Design_Patterns_Second_Edition_Code) - Code repository for Node.js Design Patterns Second Edition, published by Packt
- [nestjs/nest](https://github.com/nestjs/nest) - A progressive Node.js framework for building efficient, scalable, and enterprise-grade server-side applications with TypeScript/JavaScript 🚀
- [hemanth/nmotw.in](https://github.com/hemanth/nmotw.in) - Node Module Of The Week
- [nock/nock](https://github.com/nock/nock) - HTTP server mocking and expectations library for Node.js
- [NodeBB/NodeBB](https://github.com/NodeBB/NodeBB) - Node.js based forum software built for the modern web
...
- [1111mp/nvmd-command](https://github.com/1111mp/nvmd-command) - Provides services for nvm-desktop's Node engine version management function.
- [1111mp/nvm-desktop](https://github.com/1111mp/nvm-desktop) - Node Version Manager Desktop - A desktop application to manage multiple active node.js versions.
- [volta-cli/volta](https://github.com/volta-cli/volta) - Volta: JS Toolchains as Code. ⚡
- [microsoft/rushstack](https://github.com/microsoft/rushstack) - Monorepo for tools developed by the Rush Stack community
- [nrwl/nx](https://github.com/nrwl/nx) - Smart, Fast and Extensible Build System
...
- [nodefluent/kafka-streams](https://github.com/nodefluent/kafka-streams) - equivalent to kafka-streams :octopus: for nodejs :sparkles::turtle::rocket::sparkles:
- [openfaas/faas](https://github.com/openfaas/faas) - OpenFaaS - Serverless Functions Made Simple
- [steedos-labs/contract](https://github.com/steedos-labs/contract) - 开源合同管理系统，基于华炎魔方开发，多租户，云服务
- [steedos/steedos-accounts](https://github.com/steedos/steedos-accounts) - 华炎魔方账户管理
- [shelljs/shelljs](https://github.com/shelljs/shelljs) - :shell: Portable Unix shell commands for Node.js
- [graphql/dataloader](https://github.com/graphql/dataloader) - DataLoader is a generic utility to be used as part of your application's data fetching layer to provide a consistent API over various backends and reduce requests to those backends via batching and ca
- [Datlyfe/jira_clone](https://github.com/Datlyfe/jira_clone) - A Jira clone built with Vuejs & Nodejs/Graphql
- [fastify/website-metalsmith](https://github.com/fastify/website-metalsmith) - This project is used to build the website for fastify web framework and publish it online.
- [Unleash/unleash-client-node](https://github.com/Unleash/unleash-client-node) - Unleash client SDK for Node.js
- [huanz/wechat-mp-hack](https://github.com/huanz/wechat-mp-hack) - 微信公众平台模拟登录自动群发图文消息
- [motdotla/dotenv](https://github.com/motdotla/dotenv) - Loads environment variables from .env for nodejs projects.
...
- [i18next/i18next](https://github.com/i18next/i18next) - i18next: learn once - translate everywhere
- [axetroy/kost](https://github.com/axetroy/kost) - 基于Koa，使用Typescript开发的Web框架
- [axetroy/webuild](https://github.com/axetroy/webuild) - 零配置, 无侵入式的小程序开发工具
- [klaudiosinani/signale](https://github.com/klaudiosinani/signale) - Highly configurable logging utility
- [PacktPublishing/Node.js_Design_Patterns_Second_Edition_Code](https://github.com/PacktPublishing/Node.js_Design_Patterns_Second_Edition_Code) - Code repository for Node.js Design Patterns Second Edition, published by Packt
...
- [grantcarthew/node-rethinkdb-job-queue](https://github.com/grantcarthew/node-rethinkdb-job-queue) - A persistent job or task queue backed by RethinkDB.
- [FormidableLabs/nodejs-dashboard](https://github.com/FormidableLabs/nodejs-dashboard) - Telemetry dashboard for node.js apps from the terminal!
- [30-seconds/30-seconds-of-code](https://github.com/30-seconds/30-seconds-of-code) - Short code snippets for all your development needs
- [NodeBB/NodeBB](https://github.com/NodeBB/NodeBB) - Node.js based forum software built for the modern web
- [microsoft/napajs](https://github.com/microsoft/napajs) - Napa.js: a multi-threaded JavaScript runtime
...
- [pandazki/clash-aio](https://github.com/pandazki/clash-aio) - all-in-one clash server and control panel
...
- [vectordotdev/vrl](https://github.com/vectordotdev/vrl) - Vector Remap Language
...
- [xmindltd/xmind-embed-viewer](https://github.com/xmindltd/xmind-embed-viewer) - Use XMind share to present your .xmind files on your blog or website.
...
- [tatsy/markdown-it-imsize](https://github.com/tatsy/markdown-it-imsize) - markdown-it plugin for size-specified image markups.
...
- [node-webot/co-wechat-oauth](https://github.com/node-webot/co-wechat-oauth) - Wechat OAuth for ES6.
- [node-webot/wechat-oauth](https://github.com/node-webot/wechat-oauth) - Wechat OAuth
- [ddelange/ddelange](https://github.com/ddelange/ddelange) - 
...
- [dreamhunter2333/chatgpt_reverse_proxy](https://github.com/dreamhunter2333/chatgpt_reverse_proxy) - Chatgpt reverse proxy based on Browser
...
- [gouguoyin/chatgpt-web](https://github.com/gouguoyin/chatgpt-web) - 使用 express 和 vue3 搭建的 GPT-3 模型演示网页
...
- [zhang-zx/SINE](https://github.com/zhang-zx/SINE) - This respository contains the code for the CVPR 2023 paper SINE: SINgle Image Editing with Text-to-Image Diffusion Models.
- [youdao-ai/SRNet](https://github.com/youdao-ai/SRNet) - A tensorflow reproducing of paper “Editing Text in the wild”
- [grenlayk/text-deep-fake](https://github.com/grenlayk/text-deep-fake) - Our implementation of Text Style Brush architecture.
...
- [18870/chatgpt-proxy](https://github.com/18870/chatgpt-proxy) - A ChatGPT unofficial API proxy written in Python.
...
- [Yonsm/MiService](https://github.com/Yonsm/MiService) - XiaoMi Cloud Service for mi.com
...
- [fauna-labs/serverless-fauna](https://github.com/fauna-labs/serverless-fauna) - 
...
- [samuell/awesome-datalog](https://github.com/samuell/awesome-datalog) - Awesome datalog libraries, tools and resources
...
- [Ch0senOne/T4Toolbox](https://github.com/Ch0senOne/T4Toolbox) - 
- [olegsych/T4Toolbox](https://github.com/olegsych/T4Toolbox) - 
...
- [vincentsaluzzo/Homebrew-GUI](https://github.com/vincentsaluzzo/Homebrew-GUI) - Homebrew GUI is a UI for homebrew package Manager on Mac OS X
- [joshwiens/awesome-rethinkdb](https://github.com/joshwiens/awesome-rethinkdb) - A curated list of awesome RethinkDB resources, libraries, tools and applications
- [groovy/GMavenPlus](https://github.com/groovy/GMavenPlus) - A rewrite of GMaven, a Maven plugin for Groovy
- [haiiiiiyun/jolt-awards-books](https://github.com/haiiiiiyun/jolt-awards-books) - Jolt Awards Books List
- [peterdb/faker](https://github.com/peterdb/faker) - Groovy Faker port - create real-looking data
- [liudf0716/xfrpc](https://github.com/liudf0716/xfrpc) - The xfrpc project is an implementation of frp client written in C language for OpenWRT and IOT system. The main motivation of this project is to provide a lightweight solution for devices with limited
- [facebook/sapling](https://github.com/facebook/sapling) - A Scalable, User-Friendly Source Control System.
- [rails/sass-rails](https://github.com/rails/sass-rails) - Ruby on Rails stylesheet engine for Sass
- [jkutner/guard-jruby-rspec](https://github.com/jkutner/guard-jruby-rspec) - RSpec on JRuby without the startup cost.
...
- [jszmajda/ruby-graphviz-mindmap](https://github.com/jszmajda/ruby-graphviz-mindmap) - An addon for the graphviz library to produce mind maps
...
- [laserlemon/rspec-wait](https://github.com/laserlemon/rspec-wait) - Wait for conditions in RSpec
...
- [ASSERT-KTH/sorald](https://github.com/ASSERT-KTH/sorald) - Automatic repair system for static analysis warnings from SonarQube's SonarJava http://arxiv.org/pdf/2103.12033
- [johnpoth/jshell-maven-plugin](https://github.com/johnpoth/jshell-maven-plugin) - Maven Plugin for the Java Shell Tool (JShell)
- [ueokande/bashtub](https://github.com/ueokande/bashtub) - Tiny unittest framework for Bash.
- [AGWA/git-crypt](https://github.com/AGWA/git-crypt) - Transparent file encryption in git
- [fslaborg/Deedle](https://github.com/fslaborg/Deedle) - Easy to use .NET library for data and time series manipulation and for scientific programming
...
- [PacktPublishing/Practical-Time-Series-Analysis](https://github.com/PacktPublishing/Practical-Time-Series-Analysis) - Practical Time-Series Analysis, published by Packt
...
- [aliyun/aliyun-tsdb-java-sdk](https://github.com/aliyun/aliyun-tsdb-java-sdk) - Aliyun TSDB SDK for Java
- [facebookresearch/detr](https://github.com/facebookresearch/detr) - End-to-End Object Detection with Transformers
- [jina-ai/dalle-flow](https://github.com/jina-ai/dalle-flow) - 🌊 A Human-in-the-Loop workflow for creating HD images from text
- [datamonday/TimeSeriesMoonlightBox](https://github.com/datamonday/TimeSeriesMoonlightBox) - Time Series Analysis Models Source Code with Deep Learning Algorithms
...
- [PassFort/json-schema-to-flow-type](https://github.com/PassFort/json-schema-to-flow-type) - 
...
- [Hsins/Daily-GitHub-Trending](https://github.com/Hsins/Daily-GitHub-Trending) - 📰 Fetch daily trending repositories information on GitHub Trending Page by script writen in JavaScript and executed with GitHub Actions Service.
...
- [justengel/pydantic_property](https://github.com/justengel/pydantic_property) - Property descriptors for Pydantic
...
- [guoruibiao/Effective-Python](https://github.com/guoruibiao/Effective-Python) - 59个编写高质量Python代码的中文翻译版。
...
- [kuimono/openapi-schema-pydantic](https://github.com/kuimono/openapi-schema-pydantic) - OpenAPI (v3) specification schema as pydantic class
...
- [NxeedGoto/Refactoring2-zh](https://github.com/NxeedGoto/Refactoring2-zh) - 《重构 改善既有代码的设计第二版》中文翻译
- [HugoMatilla/Refactoring-Summary](https://github.com/HugoMatilla/Refactoring-Summary) - Summary of "Refactoring: Improving the Design of Existing Code" by Martin Fowler
...
- [python/python-docs-zh-cn](https://github.com/python/python-docs-zh-cn) - zh_CN translation of the Python documentation
...
- [shawnrice/alfred2-workflow-help](https://github.com/shawnrice/alfred2-workflow-help) - An Alfred2 workflow that will display the commands of all other workflows.
- [shawnrice/alfred-documentation](https://github.com/shawnrice/alfred-documentation) - Mostly a place to host a wiki to document Alfred
...
- [SalesforceFoundation/EDA](https://github.com/SalesforceFoundation/EDA) - Education Data Architecture
...
- [yeoman/yosay](https://github.com/yeoman/yosay) - Tell Yeoman what to say
...
- [duanfengzhi/Movie-Ticketing-System-BC](https://github.com/duanfengzhi/Movie-Ticketing-System-BC) - Java Web项目——电影购票系统
...
- [vyahello/pytest-bootcamp](https://github.com/vyahello/pytest-bootcamp) - 📚 Consist basics of pytest framework (python + pytest)
...
- [singular-labs/parametrization](https://github.com/singular-labs/parametrization) - Simpler PyTest Parametrization
- [kaste/mockito-python](https://github.com/kaste/mockito-python) - Mockito is a spying framework
- [gwtw/py-sorting](https://github.com/gwtw/py-sorting) - A collection of sorting algorithms written in Python.
- [renzon/pytest-vs-unittest](https://github.com/renzon/pytest-vs-unittest) - Comparison between pytest and unittes test frameworks
...
- [hellosean1025/node-echarts](https://github.com/hellosean1025/node-echarts) - Generate chart by echarts in nodejs.
...
- [suguoyao/miniprogram-canvas-sugarjs](https://github.com/suguoyao/miniprogram-canvas-sugarjs) - 打造一个致力于微信小程序的Canvas库，类似于H5原生JS Canvas库-FabricJS
...
- [heiye007/awesome-debugging](https://github.com/heiye007/awesome-debugging) - Why Debugging?（为什么要调试？）
- [j178/2022](https://github.com/j178/2022) - Will 2022 be better?
- [FedericoVarela/Pipenv-Tasks-for-VSCode](https://github.com/FedericoVarela/Pipenv-Tasks-for-VSCode) - Visual Studio Code extension to register Pipenv scripts as tasks
- [PhotonQuantum/magic-in-ten-mins-rs](https://github.com/PhotonQuantum/magic-in-ten-mins-rs) - 十分钟魔法练习 in Rust
- [lcc214321/Magnesium](https://github.com/lcc214321/Magnesium) - 集数据中台，开放平台，API网关，user-auth，devops，SaaS租户账号下发于一体的企业级云管控平台
- [evangui/multi-fitness-console](https://github.com/evangui/multi-fitness-console) - java多商户版健身房saas管理系统。含小程序、总后台管理、多商户前后端分离的后端接口api，用户于健身房工作人员小程序api
- [evangui/workflow](https://github.com/evangui/workflow) - 基于shopnc的系列审核工作流代码实现。含商家、商品、售后维权等大小13个业务流程。
...
- [lukas-krecan/JsonUnit](https://github.com/lukas-krecan/JsonUnit) - Compare JSON in your Unit Tests
...
- [talsma-ict/umldoclet](https://github.com/talsma-ict/umldoclet) - Automatically generate PlantUML diagrams in javadoc
...
- [ifsheldon/RustWHY](https://github.com/ifsheldon/RustWHY) - Rust 十万个为什么
...
- [psanford/donutdb](https://github.com/psanford/donutdb) - Store and query a sqlite db directly backed by DynamoDB.
...
- [microsoft/python-type-stubs](https://github.com/microsoft/python-type-stubs) - A set of type stubs for popular Python packages. These are works in progress from the Microsoft Python team and others, with the intent that they are contributed to typeshed or to the associated packa
- [xzhih/one-key-hidpi](https://github.com/xzhih/one-key-hidpi) - Enable macOS HiDPI and have a native setting.
- [garyelephant/blog](https://github.com/garyelephant/blog) - markdown content of garyelephant's blog.http://garyelephant.me
...
- [DeccaDC/Decca](https://github.com/DeccaDC/Decca) - 
...
- [marwinxxii/apschedulerweb](https://github.com/marwinxxii/apschedulerweb) - web intrface for Advanced Python Scheduler
...
- [zaynali53/DotENV](https://github.com/zaynali53/DotENV) - Syntax Highlighting support for Environment (.env) Files
...
- [w1301625107/Vue-Gantt-chart](https://github.com/w1301625107/Vue-Gantt-chart) - 使用Vue做数据控制的Gantt图表
- [xuyige/BERT4doc-Classification](https://github.com/xuyige/BERT4doc-Classification) - Code and source for paper ``How to Fine-Tune BERT for Text Classification?``
...
- [Meelfy/pytorch_pretrained_BERT](https://github.com/Meelfy/pytorch_pretrained_BERT) - 
...
- [alexchantastic/alfred-ip-address-workflow](https://github.com/alexchantastic/alfred-ip-address-workflow) - Alfred 5 workflow for getting your local and external IP addresses.
- [axetroy/vscode-package-manager](https://github.com/axetroy/vscode-package-manager) - vscode extension for managing your Packages that installed in your computer. Support Homebrew/npm/pip/yarn/apt and more
- [frigus02/vscode-sql-tagged-template-literals](https://github.com/frigus02/vscode-sql-tagged-template-literals) - VS Code extension, which enables syntax highlighting for SQL in template literals tagged with an `sql` function
...
- [ptweir/python-string-sql](https://github.com/ptweir/python-string-sql) - Highlight code in python multiline strings
- [panicsteve/shutup-css](https://github.com/panicsteve/shutup-css) - CSS stylesheet to hide comments on web pages
- [chaitjo/efficient-gnns](https://github.com/chaitjo/efficient-gnns) - Code and resources on scalable and efficient Graph Neural Networks
...
- [runemalm/ddd-for-python](https://github.com/runemalm/ddd-for-python) - A domain-driven design framework for Python.
- [anhthang/vscode-gitflow](https://github.com/anhthang/vscode-gitflow) - Gitflow integration for Visual Studio Code
- [viralogic/py-enumerable](https://github.com/viralogic/py-enumerable) - A Python module used for interacting with collections of objects using LINQ syntax
- [na-ka-na/ExcelCompare](https://github.com/na-ka-na/ExcelCompare) - Command line tool (and API) for diffing Excel Workbooks
- [hroptatyr/xls2txt](https://github.com/hroptatyr/xls2txt) - command line tool to convert excel xls files to csv
- [ckrf/xlsx-git](https://github.com/ckrf/xlsx-git) - Convert .xlsx files to XML before committing them to git
...
- [wongxming/aliyun-iot-client-sdk](https://github.com/wongxming/aliyun-iot-client-sdk) - 阿里云物联网套件硬件端SDK
...
- [mongodb/mongo-jdbc-driver](https://github.com/mongodb/mongo-jdbc-driver) - JDBC Driver for MongoDB Atlas SQL interface
...
- [alanstars/AliCloudTSDB](https://github.com/alanstars/AliCloudTSDB) - 阿里云时序数据库TSDB的HTTP请求API接口封装
- [aliyun/iotx-api-demo](https://github.com/aliyun/iotx-api-demo) - 
...
- [dotnetcore/NPOI](https://github.com/dotnetcore/NPOI) - A .NET library for reading and writing Microsoft Office binary and OOXML file formats.
...
- [keystonejs/keystone-5](https://github.com/keystonejs/keystone-5) - 
...
- [martsberger/tablepyxl](https://github.com/martsberger/tablepyxl) - A bridge between html tables and openpyxl
...
- [bradbase/xlcalculator](https://github.com/bradbase/xlcalculator) - xlcalculator converts MS Excel formulas to Python and evaluates them.
...
- [vallettea/koala](https://github.com/vallettea/koala) - Transpose your Excel calculations into python for better performances and scaling.
...
- [adamziel/mysql_merge](https://github.com/adamziel/mysql_merge) - Merge 2+ mysql databases with ease
...
- [MorbidMiyako/vue-ganttastic-tweaked](https://github.com/MorbidMiyako/vue-ganttastic-tweaked) - 
- [http-party/node-http-proxy](https://github.com/http-party/node-http-proxy) - A full-featured http proxy for node.js
- [pscj/streaming-media-subtitle](https://github.com/pscj/streaming-media-subtitle) - HBOMAX中文字幕插件 for AndroidTV
- [DVLP/run-func](https://github.com/DVLP/run-func) - Run exported function from package.json scripts
- [jqlang/jq](https://github.com/jqlang/jq) - Command-line JSON processor
- [rails4sandeep/filter-coffee](https://github.com/rails4sandeep/filter-coffee) - eslint validation as mocha tests with plenty of configuration options
- [dodrio/run-function](https://github.com/dodrio/run-function) - Run a function if it exists.
...
- [malcolmvr/diff-arrays-of-objects](https://github.com/malcolmvr/diff-arrays-of-objects) - Compare two arrays of objects, finding added, removed, updated and identical objects. Details the differences between updated objects.
- [tabeyti/jenkins-jack](https://github.com/tabeyti/jenkins-jack) - Jack into your Jenkins to execute Pipeline scripts, provide Pipeline step autocompletions, pull Shared Library step documenation, run console groovy scripts across multiple nodes, and more! Honestly, 
- [lydiandy/vlang_note](https://github.com/lydiandy/vlang_note) - V语言学习笔记
- [vlang/gitly](https://github.com/vlang/gitly) - Light and fast GitHub/GitLab alternative written in V
- [shima-park/apollo-openapi](https://github.com/shima-park/apollo-openapi) - 携程Apollo Golang版Openapi客户端
- [CodeNarc/CodeNarc](https://github.com/CodeNarc/CodeNarc) - CodeNarc source
- [bmuschko/cje-crash-course](https://github.com/bmuschko/cje-crash-course) - In-depth and hands-on practice for acing the exam.
- [drone/go-login](https://github.com/drone/go-login) - Package login provides login handlers for multiple Source Control Management systems.
- [jenkinsci/groovy-sandbox](https://github.com/jenkinsci/groovy-sandbox) - (Deprecated) Compile-time transformer to run Groovy code in a restrictive sandbox
...
- [jenkinsci/pipeline-input-step-plugin](https://github.com/jenkinsci/pipeline-input-step-plugin) - 
- [sgwozdz/jenkinsfile-support](https://github.com/sgwozdz/jenkinsfile-support) - Visual Studio Code extension
- [kubernetes/dashboard](https://github.com/kubernetes/dashboard) - General-purpose web UI for Kubernetes clusters
- [qct/apollo-helm](https://github.com/qct/apollo-helm) - Helm chart for Apollo(configuration management for distributed systems)
...
- [openzipkin/brave-example](https://github.com/openzipkin/brave-example) - A collection of examples how to use brave instrumentation in various frameworks and libraries.
- [srmeyers/git-prefix](https://github.com/srmeyers/git-prefix) - Visual Studio Code Extension - Prefix commit message with value in branch name.
...
- [initialxy/cordova-plugin-themeablebrowser](https://github.com/initialxy/cordova-plugin-themeablebrowser) - Fork of org.apache.cordova.inappbrowser in an attempt to make it a bit more themeable and configurable to add some custom actions.
...
- [gshigeto/ionic-environment-variables](https://github.com/gshigeto/ionic-environment-variables) - Easy to use environment variables for Ionic3!
...
- [FIRHQ/RaR](https://github.com/FIRHQ/RaR) - Rules and Regulations
...
- [graphql-java/graphql-java-spring](https://github.com/graphql-java/graphql-java-spring) - GraphQL Java Spring and Spring Boot integration
- [eugenp/tutorials](https://github.com/eugenp/tutorials) - Just Announced - "Learn Spring Security OAuth":
- [brightinteractive/spring-boot-web-app-context-repro](https://github.com/brightinteractive/spring-boot-web-app-context-repro) - Reproducer for Spring Boot WebApplicationContextUtils.getWebApplicationContext issue
...
- [nathco/Generate-GIF](https://github.com/nathco/Generate-GIF) - Sketch.app plugin for generating animated GIFs
...
- [LandRover/StaffjoyV2](https://github.com/LandRover/StaffjoyV2) - Staffjoy V2 - all microservices in a monorepo
...
- [tj/tj](https://github.com/tj/tj) - 
- [OWASP/www-project-dependency-track](https://github.com/OWASP/www-project-dependency-track) - OWASP Foundation Web Respository
- [mendix/Atlas-UI-Framework](https://github.com/mendix/Atlas-UI-Framework) - The shortest path to a stunning User Interface for all Mendix applications.
- [Rintagi/Low-Code-Development-Platform](https://github.com/Rintagi/Low-Code-Development-Platform) - Rintagi is the world's first open source low-code application platform with limitless extension and rejuvenation built and maintained by Robocoder Corporation. Since 1999, Robocoder Corporation has us
...
- [Qualia-Li/RepoPal](https://github.com/Qualia-Li/RepoPal) - An approach that can effectively detect similar repositories on GitHub.
...
- [fanliang11/surging](https://github.com/fanliang11/surging) - Surging is a micro-service engine that provides a lightweight, high-performance, modular RPC request pipeline.  support Event-based Asynchronous Pattern and reactive programming ,The service engine su
...
- [steedos/steedos-app-expense](https://github.com/steedos/steedos-app-expense) - 开源费控管理管理系统，基于华炎魔方开发，可自主随心定制。
- [steedos/steedos-lesson-contracts](https://github.com/steedos/steedos-lesson-contracts) - 低代码开发教程：如何快速开发随需定制的管理系统？
- [jaystack/odata-v4-parser](https://github.com/jaystack/odata-v4-parser) - OData v4 parser
- [jaystack/odata-v4-mongodb](https://github.com/jaystack/odata-v4-mongodb) - This server component lets you process OData requests over a MongoDB database
- [jsreport/jsreport](https://github.com/jsreport/jsreport) - javascript based business reporting platform :rocket:
- [EddyVerbruggen/cordova-plugin-native-keyboard](https://github.com/EddyVerbruggen/cordova-plugin-native-keyboard) - :musical_keyboard: Add a Slack / WhatsApp - style chat keyboard to your Cordova app!
...
- [xylo/intellij-postfix-templates-generator](https://github.com/xylo/intellij-postfix-templates-generator) - A Generator for Custom Postfix Tempaltes for Intellij IDEA
- [leecho/mybatis-generator-plus](https://github.com/leecho/mybatis-generator-plus) - Idea plugin for mybatis generator. Provider UI and  mapper auto merge.
...
- [e-imaxina/cordova-plugin-deeplinks](https://github.com/e-imaxina/cordova-plugin-deeplinks) - Cordova plugin to support Universal/Deep Links for iOS/Android.
- [wi3land/ionic-appauth](https://github.com/wi3land/ionic-appauth) - Intergration for OpenId/AppAuth-JS into Ionic V3/4/5
...
- [nswbmw/puppeteer-debug](https://github.com/nswbmw/puppeteer-debug) - puppeteer-debug
- [ptpaterson/netlify-faunadb-graphql-auth](https://github.com/ptpaterson/netlify-faunadb-graphql-auth) - Netlify functions example with faunadb, graphql, and authorization
...
- [sensorsdata/sa-sdk-java](https://github.com/sensorsdata/sa-sdk-java) - 神策数据官方 Java 埋点 SDK，是一款轻量级用于 Java 端的数据采集埋点 SDK。
- [rongcloud/rongcloud-web-im-sdk-v2](https://github.com/rongcloud/rongcloud-web-im-sdk-v2) - Web (JavaScript) IM SDK of RongCloud Version 2.
...
- [Skadabr/puppeteer-selector](https://github.com/Skadabr/puppeteer-selector) - advanced css selectors for puppeteer
...
- [analysys/presto-hbase-connector](https://github.com/analysys/presto-hbase-connector) - presto hbase connector 组件基于Presto Connector接口规范实现，用来给Presto增加查询HBase的功能。相比其他开源版本的HBase Connector，我们的性能要快10到100倍以上。
- [databricks/benchmarks](https://github.com/databricks/benchmarks) - A place in which we publish scripts for reproducible benchmarks.
...
- [Smartling/keycloak-user-migration-provider](https://github.com/Smartling/keycloak-user-migration-provider) - Provides a Keycloak user federation provider for migrating users from a legacy system to Keycloak with zero downtime.
...
- [ohioit/kong-oauth-sso](https://github.com/ohioit/kong-oauth-sso) - Kong OAuth SSO Integration
- [RockyLOMO/rxlib](https://github.com/RockyLOMO/rxlib) - A set of core libraries for Java
...
- [Ethaan/vuexpresso](https://github.com/Ethaan/vuexpresso) - :crystal_ball: VueJS + Express + GraphQL Boilerplate
...
- [fenos/graphql-thinky](https://github.com/fenos/graphql-thinky) - GraphQL & Relay powered by thinky / RethinkDB. https://graphql-thinky.readme.io/
- [rethinkdb/rethinkdb-ts](https://github.com/rethinkdb/rethinkdb-ts) - RethinkDB TypeScript driver
- [rethinkdb/rethinkdb-desktop](https://github.com/rethinkdb/rethinkdb-desktop) - RebirthDB admin as desktop app
...
- [netlify/netlify-faunadb-example](https://github.com/netlify/netlify-faunadb-example) - Using FaunaDB with netlify functions
- [DavidWells/serverless-workshop](https://github.com/DavidWells/serverless-workshop) - ⚡️ Open source serverless workshop. Ready to deploy serverless examples on AWS
...
- [Talend/tbd-studio-se](https://github.com/Talend/tbd-studio-se) - Studio open source projects related to Big Data
...
- [adubkov/zbx_redis_template](https://github.com/adubkov/zbx_redis_template) - Zabbix template for Redis
- [qiueer/zabbix](https://github.com/qiueer/zabbix) - zabbix功能扩展，主要监控tomcat,mysql,redis,mongodb,memcached,nginx等中间件
- [cluther/jmx-tester](https://github.com/cluther/jmx-tester) - Small Java application for testing JMX MBeans.
...
- [vdesabou/alfred-convert-word-to-pdf](https://github.com/vdesabou/alfred-convert-word-to-pdf) - Alfred workflow to convert Word document to PDF
...
- [zqjflash/webview-debug](https://github.com/zqjflash/webview-debug) - 移动端webview页面调试
...
- [rethinkdb/rethinkdb-js](https://github.com/rethinkdb/rethinkdb-js) - An advanced Node.js driver for RethinkDB with a connection pool, support for streams etc.
...
- [servicemesher/envoy](https://github.com/servicemesher/envoy) - Envoy proxy中文文档 - https://www.servicemesher.com/envoy/
- [liu11hao11/keystone-storage-adapter-qiniu](https://github.com/liu11hao11/keystone-storage-adapter-qiniu) - qiniu storage adapter for keystonejs
...
- [TooTallNate/node-socks-proxy-agent](https://github.com/TooTallNate/node-socks-proxy-agent) - A SOCKS (v4/v5) proxy `http.Agent` implementation for HTTP and HTTPS
...
- [hjkcai/wepy-plugin-axios](https://github.com/hjkcai/wepy-plugin-axios) - 在 wepy 中使用 axios
- [dtao/lazy.js](https://github.com/dtao/lazy.js) - Like Underscore, but lazier
- [vwxyzh/strange-dotnet](https://github.com/vwxyzh/strange-dotnet) - Strange thing in dotnet.
- [IndexXuan/v2ex-api-bridge](https://github.com/IndexXuan/v2ex-api-bridge) - V2EX APIs - powered by Egg(Node.js 7.6.0+) docs:https://indexxuan.github.io/v2ex-api-bridge/api/index.html
...
- [tc39/proposal-ptc-syntax](https://github.com/tc39/proposal-ptc-syntax) - Discussion and specification for an explicit syntactic opt-in for Tail Calls.
- [NodePartyShanghai/party](https://github.com/NodePartyShanghai/party) - 
...
- [Kadavi/iot](https://github.com/Kadavi/iot) - 
- [cuketest/demos](https://github.com/cuketest/demos) - Demos for CukeTest product
- [kieler/elkjs](https://github.com/kieler/elkjs) - ELK's layout algorithms for JavaScript
- [theia-ide/sprotty](https://github.com/theia-ide/sprotty) - A next-gen web-based graphics framework
...
- [segmentio/in-eu](https://github.com/segmentio/in-eu) - 🇪🇺 privacy first EU detection library for browsers
...
- [gutenye/sails-rethinkdb](https://github.com/gutenye/sails-rethinkdb) - a RethinkDB Adapter for Sails.js
...
- [byr-gdp/v2ex-around](https://github.com/byr-gdp/v2ex-around) - 收集 GitHub 上 V2EX 周边应用
- [CzBiX/v2ex-android](https://github.com/CzBiX/v2ex-android) - V2EX client for Android
...
- [xtx1130/blog](https://github.com/xtx1130/blog) - talk is cheap, show me your code
- [npmdoc/node-npmdoc-keystone](https://github.com/npmdoc/node-npmdoc-keystone) - 
...
- [MiniProfiler/node](https://github.com/MiniProfiler/node) - A simple but effective mini-profiler for Node.js websites
...
- [darrenqc/BottleneckP](https://github.com/darrenqc/BottleneckP) - asynchronous rate limiter with priority
...
- [koajs/cors](https://github.com/koajs/cors) - Cross-Origin Resource Sharing(CORS) for koa
...
- [hongfanqie/peer-dependencies](https://github.com/hongfanqie/peer-dependencies) - Chinese translation for a blog of npm package.json field peerDependencies
- [babel/example-node-server](https://github.com/babel/example-node-server) - Example Node Server w/ Babel
- [kmagiera/babel-watch](https://github.com/kmagiera/babel-watch) - Reload your babel-node app on JS source file changes. And do it fast.
...
- [sjmeverett/rethink-plus](https://github.com/sjmeverett/rethink-plus) - The RethinkDB interface you know with connection pooling and slightly easier usage.
...
- [uy-xela/atom-tomatimer](https://github.com/uy-xela/atom-tomatimer) - A straightforward pomodoro timer for Atom.
...
- [negativetwelve/jest-plugins](https://github.com/negativetwelve/jest-plugins) - Adds plugins feature to jest for easily adding extensions.
- [Unitech/pm2-deploy](https://github.com/Unitech/pm2-deploy) - Deploy part of PM2
- [feathersjs-ecosystem/feathers-rethinkdb](https://github.com/feathersjs-ecosystem/feathers-rethinkdb) - A Feathers service adapter for RethinkDB.
...
- [building5/node-promirepl](https://github.com/building5/node-promirepl) - A promise infused Node.js REPL
...
- [vector-of-bool/vscode-gitflow](https://github.com/vector-of-bool/vscode-gitflow) - Gitflow integration for Visual Studio Code
- [microsoft/vscode-recipes](https://github.com/microsoft/vscode-recipes) - 
- [postmanlabs/newman](https://github.com/postmanlabs/newman) - Newman is a command-line collection runner for Postman
- [codemirror/codemirror5](https://github.com/codemirror/codemirror5) - In-browser code editor (version 5, legacy)
- [pm2-hive/pm2-gelf](https://github.com/pm2-hive/pm2-gelf) - GELF Logging Module for PM2
...
- [NodeBB-China/NodeBB-China](https://github.com/NodeBB-China/NodeBB-China) - NodeBB中国：专注解决NodeBB的使用问题
- [blademainer/miwifi-ss](https://github.com/blademainer/miwifi-ss) - 小米路由 ss
...
- [jeffmo/eslint-plugin-flow-typed](https://github.com/jeffmo/eslint-plugin-flow-typed) - 
...
- [marmol-dev/thinky.d.ts](https://github.com/marmol-dev/thinky.d.ts) - Thinky ORM Typescript definitions
- [microsoft/vscode-tips-and-tricks](https://github.com/microsoft/vscode-tips-and-tricks) - Collection of helpful tips and tricks for VS Code.
- [baruch/rethink-miner](https://github.com/baruch/rethink-miner) - A data mining helper for rethinkdb, collect your queries and keep them for reuse
- [neumino/chateau](https://github.com/neumino/chateau) - Another (awesome) data explorer for RethinkDB
...
- [biggora/caminte](https://github.com/biggora/caminte) - Cross-db ORM for NodeJS
- [yocontra/thinky-export-schema](https://github.com/yocontra/thinky-export-schema) - Export a schema to a normal object for serialization
...
- [ajgon/alfred2-quiver-search](https://github.com/ajgon/alfred2-quiver-search) - Dumb quiver searcher for Alfred
- [danielecook/Quiver-alfred](https://github.com/danielecook/Quiver-alfred) - Search Quiver from Alfred
...
- [pandazki/alfred-qr-reco](https://github.com/pandazki/alfred-qr-reco) - QR Code Recognition
...
- [nativefier/nativefier-icons](https://github.com/nativefier/nativefier-icons) - Server and Icon Repository for Nativefier
...
- [timtian/gulp-rev-easy](https://github.com/timtian/gulp-rev-easy) - 
...
- [keystonejs/generator-keystone-react](https://github.com/keystonejs/generator-keystone-react) - ⚠️ Archived - Legacy Yeoman generator for a KeystoneJS / React.js boilerplate project
- [elementalui/elemental](https://github.com/elementalui/elemental) - A flexible and beautiful UI framework for React.js
- [keystonejs/generator-keystone](https://github.com/keystonejs/generator-keystone) - ⚠️ Archived - Legacy KeystoneJS project generator for Yeoman
...
- [robb/FLXView](https://github.com/robb/FLXView) - A UIView that uses Flexbox for layouting. :sparkles:
- [icindy/wxflex](https://github.com/icindy/wxflex) - 微信小程序的Flex布局demo－4种必备常用的Flex布局模式
- [Tencent/weui-wxss](https://github.com/Tencent/weui-wxss) - A UI library by WeChat official design team, includes the most useful widgets/modules.
- [show0k/docker-miniconda-armv7](https://github.com/show0k/docker-miniconda-armv7) - Image used to build linux-armv7 conda package on x64 hardware
- [pandazki/vscode-pzformat](https://github.com/pandazki/vscode-pzformat) - A clipboard format utility base on the sprintf.js.
- [rauschma/enumify](https://github.com/rauschma/enumify) - 
- [a805766066/kotlin-doc-cn](https://github.com/a805766066/kotlin-doc-cn) - kotlin官方文档翻译
...
- [graylog-labs/graylog-contentpack-nginx](https://github.com/graylog-labs/graylog-contentpack-nginx) - A nginx content pack for Graylog
- [rethinkdb/rethinkdb](https://github.com/rethinkdb/rethinkdb) - The open-source database for the realtime web.
- [mbroadst/thinkagain](https://github.com/mbroadst/thinkagain) - A Node.js ODM for RethinkDB featuring first-class support for JSON schema
- [ZijianHe/koa-router](https://github.com/ZijianHe/koa-router) - Router middleware for koa.
- [rethinkdb/rethinkdb-dockerfiles](https://github.com/rethinkdb/rethinkdb-dockerfiles) - Dockerfiles for past and present versions of RethinkDB.
- [JohanObrink/rethink-mock](https://github.com/JohanObrink/rethink-mock) - A mocking library for unit testing rethinkdb with mocha and sinon
- [webdzq/plugins](https://github.com/webdzq/plugins) - 常用扩展方法methods，一些组件components，一些编辑器的插件
- [isaacs/rimraf](https://github.com/isaacs/rimraf) - A `rm -rf` util for nodejs
- [thebruce/semverist](https://github.com/thebruce/semverist) - Semver Inspection and Utilities for Semver Object and Directory hierarchies
...
- [CampbellSoftwareSolutions/mongoose-id-validator](https://github.com/CampbellSoftwareSolutions/mongoose-id-validator) - Mongoose plug in to validate ObjectID references point to valid existing documents.
- [Tencent/wepy](https://github.com/Tencent/wepy) - 小程序组件化开发框架
- [maichong/labrador](https://github.com/maichong/labrador) - 微信小程序模块化开发框架
- [Dreamacro/koa-wxsession](https://github.com/Dreamacro/koa-wxsession) - Wechat session authorization and validation middleware
- [chux0519/koa2wechat](https://github.com/chux0519/koa2wechat) - 微信公众号接入koa2中间件
- [KualiCo/koa-generic-session-rethinkdb](https://github.com/KualiCo/koa-generic-session-rethinkdb) - Session store for rethinkdb and koa-generic-session module
- [neumino/thinky](https://github.com/neumino/thinky) - JavaScript ORM for RethinkDB
- [neumino/rethinkdbdash](https://github.com/neumino/rethinkdbdash) - An advanced Node.js driver for RethinkDB with a connection pool, support for streams etc.
- [hden/koa-rethinkdb](https://github.com/hden/koa-rethinkdb) - Koa middleware that gets you a RethinkDB client
- [Automattic/monk](https://github.com/Automattic/monk) - The wise MongoDB API
- [davide/docker-zerotier](https://github.com/davide/docker-zerotier) - Docker + ZeroTier = &lt;3
...
- [Krb686/nanotimer](https://github.com/Krb686/nanotimer) - A much higher accuracy timer object that makes use of the node.js hrtime function call.
...
- [simpleapples/magicsearch](https://github.com/simpleapples/magicsearch) - 搜索引擎聚合页面，带搜索引擎名称自动补全功能。
- [h2y/allso](https://github.com/h2y/allso) - 超实用双栏聚合搜索引擎，web 单页面 App。充分利用屏幕信息显示资源，输入一个关键字，将自动提交给左右两个搜索引擎，同时返回他们的搜索结果！
...
- [wuchangming/node-mitmproxy](https://github.com/wuchangming/node-mitmproxy) - node-mitmproxy is an extensible man-in-the-middle(MITM) proxy server for HTTP/HTTPS base on Node.js.
- [hteen/docker-lnmp](https://github.com/hteen/docker-lnmp) - Docker部署PHP环境(PHP,MySQL,Nginx,Redis)
...
- [bborn/opensauna](https://github.com/bborn/opensauna) - Sauna - a social news reader and curation tool
- [ncarlier/nunux-keeper](https://github.com/ncarlier/nunux-keeper) - A open source content curation system.
- [SuperITMan/docker-fail2ban](https://github.com/SuperITMan/docker-fail2ban) - A simple fail2ban to use inside a Docker
...
- [cerebroapp/cerebro-devdocs](https://github.com/cerebroapp/cerebro-devdocs) - 📦Cerebro plugin for search in dev. documentations provided by devdocs.io
...
- [XYUU/ChaZD](https://github.com/XYUU/ChaZD) - 好学单词-ChaZD 查字典的分支，支持划词，自动加入扇贝单词生词本，方便手机同步学习。
...
- [crsmithdev/hint](https://github.com/crsmithdev/hint) - A simple mindfulness reminder for macOS
...
- [adambutler/alfred-workflow-package-manager](https://github.com/adambutler/alfred-workflow-package-manager) - A WIP package manager for Alfred workflows
- [limodou/ulipad](https://github.com/limodou/ulipad) - wxpython + python based Editor
...
- [yangtao309/yangtao309.github.com](https://github.com/yangtao309/yangtao309.github.com) - 
...
- [tomighty/tomighty](https://github.com/tomighty/tomighty) - Old Tomighty repo. For the new repos, please refer to: tomighty-osx and tomighty-windows
...
- [lawloretienne/TinderStack](https://github.com/lawloretienne/TinderStack) - A stack of cards similar to Tinder
...
- [usmanismail/go-messenger](https://github.com/usmanismail/go-messenger) - 
- [justjavac/awesome-wechat-weapp](https://github.com/justjavac/awesome-wechat-weapp) - 微信小程序开发资源汇总 :100:
- [haiiiiiyun/awesome-docker-cn](https://github.com/haiiiiiyun/awesome-docker-cn) - Docker 优秀资源集锦
- [oneapm/docker-oneapm-ci-agent](https://github.com/oneapm/docker-oneapm-ci-agent) - Dockerfile for building Cloudinsight Agent image.
- [esnet/iperf](https://github.com/esnet/iperf) - iperf3:  A TCP, UDP, and SCTP network bandwidth measurement tool
- [irsl/dfwfw](https://github.com/irsl/dfwfw) - Docker Firewall Framework
- [dearrrfish/KeePassenger](https://github.com/dearrrfish/KeePassenger) - Alfred workflow for KeePass databases, with a node-based service api server as support.
...
- [ngerakines/express-typescript-sequelize](https://github.com/ngerakines/express-typescript-sequelize) - 
- [qiniu/qshell](https://github.com/qiniu/qshell) - Shell Tools for Qiniu Cloud
- [madhums/mongoose-migrate](https://github.com/madhums/mongoose-migrate) - mongodb migrations for node
- [mixu/npm_lazy](https://github.com/mixu/npm_lazy) - A lazy local cache for NPM to make your local deploys faster
- [crosswalk-project/cordova-plugin-crosswalk-webview](https://github.com/crosswalk-project/cordova-plugin-crosswalk-webview) - Crosswalk WebView Cordova Plugin (UNMAINTAINED)
- [node-modules/graceful](https://github.com/node-modules/graceful) - Graceful exit when `uncaughtException` emit, base on `process.on('uncaughtException')`.
- [mhart/gelfling](https://github.com/mhart/gelfling) - Create and send GELF (Graylog2) messages in node.js, including chunking
- [s-a/sublime-text-refactor](https://github.com/s-a/sublime-text-refactor) - A Sublime Text Refactor Plugin for Javascript Code
- [joneshf/sublime-grasp](https://github.com/joneshf/sublime-grasp) - Grasp from sublime
...
- [mhart/gelf-stream](https://github.com/mhart/gelf-stream) - A node.js stream to send JS objects to a Graylog2 server (in GELF format)
- [brianloveswords/messina](https://github.com/brianloveswords/messina) - Pipe your Bunyan logs to Graylog2 with standard unix pipes
- [abbshr/rfc7540-translation-zh_cn](https://github.com/abbshr/rfc7540-translation-zh_cn) - RFC 7540 - HTTP/2 中文翻译版
...
- [squaremo/rabbit.js](https://github.com/squaremo/rabbit.js) - Messaging in Node.JS made easy using RabbitMQ
...
- [permissions-dispatcher/permissions-dispatcher-plugin](https://github.com/permissions-dispatcher/permissions-dispatcher-plugin) - IntelliJ plugin for supporting PermissionsDispatcher
- [square/otto-intellij-plugin](https://github.com/square/otto-intellij-plugin) - An IntelliJ IDEA plugin to navigate between events posted by Otto.
- [HappenApps/Quiver](https://github.com/HappenApps/Quiver) - Quiver documentation and issue tracker
- [timmutton/redex-plugin](https://github.com/timmutton/redex-plugin) - 
- [square/haha](https://github.com/square/haha) - DEPRECATED Java library to automate the analysis of Android heap dumps.
- [liaohuqiu/cube-sdk](https://github.com/liaohuqiu/cube-sdk) - A light package for Android development, it handles loading image and network request.
- [ihrthk/pgyer](https://github.com/ihrthk/pgyer) - More convenient use pgyer
...
- [michaelrbk/showCaseCordova](https://github.com/michaelrbk/showCaseCordova) - Show Case Cordova
...
- [fspinillo/alfred-digital-ocean](https://github.com/fspinillo/alfred-digital-ocean) - Check status of your Digital Ocean droplets
...
- [kaiye/workflows-youdao](https://github.com/kaiye/workflows-youdao) - 学英语和写工具
...
- [pedrovgs/AndroidWiFiADB](https://github.com/pedrovgs/AndroidWiFiADB) - IntelliJ/AndroidStudio plugin which provides a button to connect your Android device over WiFi to install, run and debug your applications without a USB connected.
- [layerlre/ADBWIFI](https://github.com/layerlre/ADBWIFI) - This repo is deprecated. // ADBWIFI Android Studio plugin for debug android app over Wi-Fi.
...
- [desmond1121/Android-Ptr-Comparison](https://github.com/desmond1121/Android-Ptr-Comparison) - Performance comparison of android "pull to refresh" repos in github.
...
- [bmarrdev/android-DecoView-charting](https://github.com/bmarrdev/android-DecoView-charting) - DecoView: Android arc based animated charting library
...
- [orhanobut/bee](https://github.com/orhanobut/bee) - Debug and QA tool for android
- [bigbluebutton/bigbluebutton](https://github.com/bigbluebutton/bigbluebutton) - Complete open source web conferencing system.
- [wrapp-archive/floatlabelededittext](https://github.com/wrapp-archive/floatlabelededittext) - Floating hint from edit text - inspired by Matt D. Smith's design: http://dribbble.com/shots/1254439--GIF-Mobile-Form-Interaction?list=users
...
- [aslansky/css-sprite](https://github.com/aslansky/css-sprite) - css sprite generator
...
- [zhx19940113/Android_jdy](https://github.com/zhx19940113/Android_jdy) - 真宝岛是一款理财产品介绍推荐软件，用户可通过查找功能找到国内正规金融机构发行和销售的银行类理财产品、保险理财产品，公募基金，信托理财，资管理财，债权众筹，股权众筹，私募基金等类型产品，用户可通过真宝岛向自己的好友推荐产品赚取推荐积分与红包。
- [zackyang000/node-odata](https://github.com/zackyang000/node-odata) - A library for easily create OData REST API, abide by OData protocol.
- [n1k0/SublimeHighlight](https://github.com/n1k0/SublimeHighlight) - A humble SublimeText package for exporting highlighted code as RTF or HTML
- [dfwyt2011/EverNote](https://github.com/dfwyt2011/EverNote) - 自学android两个月，上手练习的一款材料设计风格的个人笔记本，新手值得看一看
- [henrypoydar/evernote-editor](https://github.com/henrypoydar/evernote-editor) - Simple command line creation and editing of Evernote notes with Markdown and your favorite text editor
- [uuidjs/uuid](https://github.com/uuidjs/uuid) - Generate RFC-compliant UUIDs in JavaScript
- [ganemone/NodeRequirer](https://github.com/ganemone/NodeRequirer) - A Sublime Text 3 plugin for requiring modules.
...
- [ironSource/node-generator-chrome-ninja](https://github.com/ironSource/node-generator-chrome-ninja) - Yeoman Chrome extension generator
...
- [pluma/dekeywordify](https://github.com/pluma/dekeywordify) - UNMAINTAINED. Browserify transform to escape reserved property keyword names.
...
- [fibo/strict-mode](https://github.com/fibo/strict-mode) - enables strict mode in your package
...
- [brotchie/CocoaFlux](https://github.com/brotchie/CocoaFlux) - In-progress implementation of the Facebook Flux architectural pattern for iOS.
- [zzzprojects/EntityFramework.Extended](https://github.com/zzzprojects/EntityFramework.Extended) - Add-on feature for Entity Framework
- [kinwahlai/XcodeRefactoringPlus](https://github.com/kinwahlai/XcodeRefactoringPlus) - Xcode Refactoring extention
- [hehonghui/Colorful](https://github.com/hehonghui/Colorful) - 基于Theme的Android动态换肤库，无需重启Activity、无需自定义View，方便的实现日间、夜间模式。
- [bumaociyuan/JSFormatter-Xcode](https://github.com/bumaociyuan/JSFormatter-Xcode) - Xcode plug to format js html css files
- [arv/ExplorerCanvas](https://github.com/arv/ExplorerCanvas) - Canvas for IE8 and older
- [samuelneff/sequelize-auto-ts](https://github.com/samuelneff/sequelize-auto-ts) - Generate Sequelize definition statements and compatible TypeScript definitions from a database schema
- [bminer/node-mysql-queues](https://github.com/bminer/node-mysql-queues) - Wraps 'node-mysql' to provide mulitple query queues, allowing support for multiple statements and transactions.
- [geftimov/android-patternview](https://github.com/geftimov/android-patternview) - Pattern view for android.That one using lock or unlock.
- [octalmage/robotjs](https://github.com/octalmage/robotjs) - Node.js Desktop Automation.
- [lholmquist/generator-cordova-plugin](https://github.com/lholmquist/generator-cordova-plugin) - 
- [Almeros/android-gesture-detectors](https://github.com/Almeros/android-gesture-detectors) - Gesture detector framework for multitouch handling on Android, based on Android's ScaleGestureDetector
- [jackcallister/redux-isomorphic-example](https://github.com/jackcallister/redux-isomorphic-example) - 
...
- [XiaoYulong/YLSwipeLockView](https://github.com/XiaoYulong/YLSwipeLockView) - a swipe password view to unlock an application written in objective-c.
- [CN-Chrome-DevTools/CN-Chrome-DevTools](https://github.com/CN-Chrome-DevTools/CN-Chrome-DevTools) - Chrome开发者工具中文手册
- [Parallels/jenkins-parallels](https://github.com/Parallels/jenkins-parallels) - A Jenkins plugin to run builds in Parallels Desktop
- [ericelliott/express-error-handler](https://github.com/ericelliott/express-error-handler) - A graceful error handler for Express and Restify applications.
...
- [fdecampredon/rx-react](https://github.com/fdecampredon/rx-react) - ReactJS bindings for RxJS
- [jurassix/react-validation-mixin](https://github.com/jurassix/react-validation-mixin) - Simple validation mixin (HoC) for React.
...
- [Flowerowl/ici](https://github.com/Flowerowl/ici) - :boom:A dictionary used by programmers in the command line
- [petehunt/node-jsx](https://github.com/petehunt/node-jsx) - transparently require() jsx from within node
- [onlytiancai/android-httpdns](https://github.com/onlytiancai/android-httpdns) - 
- [retro/apitizer](https://github.com/retro/apitizer) - API mocking for the client side JavaScript applications
- [gwtproject/gwt](https://github.com/gwtproject/gwt) - GWT Open Source Project
- [node-modules/hessian.js](https://github.com/node-modules/hessian.js) - js hessian binary web service protocol, support communicate with java
...
- [undoZen/bigpipe-on-node](https://github.com/undoZen/bigpipe-on-node) - implementing bigpipe on node.js
- [kirbysayshi/vash](https://github.com/kirbysayshi/vash) - Vash, the 60 billion double-dollar template-maker. Razor syntax, for JavaScript templates
...
- [Drarok/rsub](https://github.com/Drarok/rsub) - Use rmate with Sublime Text 2.
...
- [pcimino/nodejs-restify-mongodb](https://github.com/pcimino/nodejs-restify-mongodb) - Demonstration CRUD REST services
...
- [7nights/Time-is-Money](https://github.com/7nights/Time-is-Money) - Time is Money 系列
...
- [flyerhzm/activemerchant_patch_for_china](https://github.com/flyerhzm/activemerchant_patch_for_china) - A rails plugin to add an active_merchant patch for china online payment platform including alipay (支付宝), 99bill (快钱) and tenpay (财付通)
- [blovemaple/mahjong](https://github.com/blovemaple/mahjong) - 用Java写的单机命令行麻将游戏。A command-line Chinese Mahjong game, written in Java.
...
- [jgilfelt/GhostLog](https://github.com/jgilfelt/GhostLog) - Android app that displays the logcat buffer in a system overlay window
...
- [E3V3A/pip-date](https://github.com/E3V3A/pip-date) - A simple CLI tool to show the installation/modification times of all your pip packages
- [langgenius/dify](https://github.com/langgenius/dify) - One API for plugins and datasets, one interface for prompt engineering and visual operation, all for creating powerful AI applications.
...
- [python-poetry/poetry](https://github.com/python-poetry/poetry) - Python packaging and dependency management made easy
- [yhino/pipenv-poetry-migrate](https://github.com/yhino/pipenv-poetry-migrate) - This is simple migration script, migrate pipenv to poetry
...
- [nicohlr/ipychart](https://github.com/nicohlr/ipychart) - The power of Chart.js with Python
- [DHI/tsod](https://github.com/DHI/tsod) - Anomaly Detection for time series data
- [kovidgoyal/kitty](https://github.com/kovidgoyal/kitty) - Cross-platform, fast, feature-rich, GPU based terminal
...
- [tiangolo/full-stack-fastapi-postgresql](https://github.com/tiangolo/full-stack-fastapi-postgresql) - Full stack, modern web application generator. Using FastAPI, PostgreSQL as database, Docker, automatic HTTPS and more.
- [RudyBekker/SuperSaaSFastAPI](https://github.com/RudyBekker/SuperSaaSFastAPI) - Python SaaS Boilerplate for building Software-as-Service (SAAS) apps with FastAPI, Vue.js & Tailwind
- [plotly/plotly.py](https://github.com/plotly/plotly.py) - The interactive graphing library for Python :sparkles: This project now includes Plotly Express!
...
- [py-why/dowhy](https://github.com/py-why/dowhy) - DoWhy is a Python library for causal inference that supports explicit modeling and testing of causal assumptions. DoWhy is based on a unified language for causal inference, combining causal graphical 
- [datamonday/Time-Series-Analysis-Tutorial](https://github.com/datamonday/Time-Series-Analysis-Tutorial) - 时间序列分析教程
- [Alro10/deep-learning-time-series](https://github.com/Alro10/deep-learning-time-series) - List of papers, code and experiments using deep learning for time series forecasting
...
- [Textualize/rich](https://github.com/Textualize/rich) - Rich is a Python library for rich text and beautiful formatting in the terminal.
- [static-frame/static-frame](https://github.com/static-frame/static-frame) - Immutable and grow-only Pandas-like DataFrames with a more explicit and consistent interface.
- [VirtusLab/pandas-stubs](https://github.com/VirtusLab/pandas-stubs) - Pandas type stubs. Helps you type-check your code.
- [joowani/binarytree](https://github.com/joowani/binarytree) - Python Library for Studying Binary Trees
- [tiangolo/typer-cli](https://github.com/tiangolo/typer-cli) - Run Typer scripts with completion, without having to create a package, using Typer CLI.
- [bloomberg/memray](https://github.com/bloomberg/memray) - Memray is a memory profiler for Python
- [mpkocher/pydantic-cli](https://github.com/mpkocher/pydantic-cli) - Turn Pydantic defined Data Models into CLI Tools
...
- [shoutem/ui](https://github.com/shoutem/ui) - Customizable set of components for React Native applications
- [feathersjs/feathers](https://github.com/feathersjs/feathers) - The API and real-time application framework
- [mastermoo/rn-wunderlist](https://github.com/mastermoo/rn-wunderlist) - Wunderlist Clone written in React Native
...
- [parse-community/parse-server](https://github.com/parse-community/parse-server) - Parse Server for Node.js / Express
- [frappe/frappe](https://github.com/frappe/frappe) - Low code web framework for real world applications, in Python and Javascript
- [malys/keycloak-rest_federation](https://github.com/malys/keycloak-rest_federation) - Keycloak federation to synchronize users from **business REST API** to Keycloak.
- [microsoft/api-guidelines](https://github.com/microsoft/api-guidelines) - Microsoft REST API Guidelines
- [Huachao/vscode-restclient](https://github.com/Huachao/vscode-restclient) - REST Client Extension for Visual Studio Code

## reverse-engineering 

- [acheong08/BingImageCreator](https://github.com/acheong08/BingImageCreator) - High quality image generation by Microsoft. Reverse engineered API.
- [xtekky/gpt4free](https://github.com/xtekky/gpt4free) - The official gpt4free repository | various collection of powerful language models
- [IntelligenzaArtificiale/Free-Auto-GPT](https://github.com/IntelligenzaArtificiale/Free-Auto-GPT) - Free Auto GPT with NO paids API is a repository that offers a simple version of Auto GPT, an autonomous AI agent capable of performing tasks independently. Unlike other versions, our implementation do
- [WerWolv/ImHex](https://github.com/WerWolv/ImHex) - 🔍 A Hex Editor for Reverse Engineers, Programmers and people who value their retinas when working at 3 AM.
- [Hack-with-Github/Awesome-Hacking](https://github.com/Hack-with-Github/Awesome-Hacking) - A collection of various awesome lists for hackers, pentesters and security researchers
...
- [rubocop/rubocop-performance](https://github.com/rubocop/rubocop-performance) - An extension of RuboCop focused on code performance checks.
- [Shopify/rubocop-sorbet](https://github.com/Shopify/rubocop-sorbet) - A collection of RuboCop rules for Sorbet
...
- [shelljs/shelljs](https://github.com/shelljs/shelljs) - :shell: Portable Unix shell commands for Node.js
- [dylanaraps/pure-bash-bible](https://github.com/dylanaraps/pure-bash-bible) - 📖 A collection of pure bash alternatives to external processes.
- [vercel/zsh-theme](https://github.com/vercel/zsh-theme) - Yet another zsh theme
...
- [tldraw/tldraw](https://github.com/tldraw/tldraw) - a very good whiteboard
- [MohamedYoussouf/Design-Resources](https://github.com/MohamedYoussouf/Design-Resources) - A curated list of design resources from design templates, stock photos, icons, colors, and much more.
- [ant-design/kitchen](https://github.com/ant-design/kitchen) - Powerful sketch plugin for design cooperation 🍳🍳🍳
- [sketch-hq/sketch-image-compressor](https://github.com/sketch-hq/sketch-image-compressor) - A Plugin for Sketch that compresses your bitmap assets, to keep filesize to a minimum.
- [airbnb/react-sketchapp](https://github.com/airbnb/react-sketchapp) - render React components to Sketch ⚛️💎
- [weui/weui-design](https://github.com/weui/weui-design) - Design package for WeUI
- [romannurik/Sketch-ArtboardTricks](https://github.com/romannurik/Sketch-ArtboardTricks) - A variety of artboard-related utilities for Sketch, primarily rearranging them into a grid, numbering them, etc.
...
- [itwanger/toBeBetterJavaer](https://github.com/itwanger/toBeBetterJavaer) - 一份通俗易懂、风趣幽默的Java学习指南，内容涵盖Java基础、Java并发编程、Java虚拟机、Java企业级开发、Java面试等核心知识点。学Java，就认准二哥的Java进阶之路😄
- [donglight/bookstore](https://github.com/donglight/bookstore) - springboot+mybatis+shiro的电商书城系统
- [jeecgboot/jeecg-boot](https://github.com/jeecgboot/jeecg-boot) - 🔥「企业级低代码平台」前后端分离架构SpringBoot 2.x，SpringCloud，Ant Design&Vue，Mybatis，Shiro，JWT。强大的代码生成器让前后端代码一键生成，无需写任何代码! 引领新的开发模式OnlineCoding-&gt;代码生成-&gt;手工MERGE，帮助Java项目解决70%重复工作，让开发更关注业务，既能快速提高效率，帮助公司节省成本，同时又不失灵活
- [macrozheng/mall](https://github.com/macrozheng/mall) - mall项目是一套电商系统，包括前台商城系统及后台管理系统，基于SpringBoot+MyBatis实现，采用Docker容器化部署。 前台商城系统包含首页门户、商品推荐、商品搜索、商品展示、购物车、订单流程、会员中心、客户服务、帮助中心等模块。 后台管理系统包含商品管理、订单管理、会员管理、促销管理、运营管理、内容管理、统计报表、财务管理、权限管理、设置等模块。
...
- [bregman-arie/devops-exercises](https://github.com/bregman-arie/devops-exercises) - Linux, Jenkins, AWS, SRE, Prometheus, Docker, Python, Ansible, Git, Kubernetes, Terraform, OpenStack, SQL, NoSQL, Azure, GCP, DNS, Elastic, Network, Virtualization. DevOps Interview Questions
- [vulkd/vscode-inline-sql-formatter](https://github.com/vulkd/vscode-inline-sql-formatter) - "Beautify" SQL in any file 💅
- [datafuselabs/databend](https://github.com/datafuselabs/databend) - A modern cloud data warehouse focusing on reducing cost and complexity for your massive-scale analytics needs. Open source alternative to Snowflake. Also available in the cloud: https://app.databend.c
- [taosdata/TDengine](https://github.com/taosdata/TDengine) - TDengine is an open source, high-performance, cloud native time-series database optimized for Internet of Things (IoT), Connected Cars, Industrial IoT and DevOps.
- [cockroachdb/cockroach](https://github.com/cockroachdb/cockroach) - CockroachDB - the open source, cloud-native distributed SQL database.
- [WeBankFinTech/Scriptis](https://github.com/WeBankFinTech/Scriptis) - Scriptis is for interactive data analysis with script development(SQL, Pyspark, HiveQL), task submission(Spark, Hive), UDF, function, resource management and intelligent diagnosis.
...
- [doug-martin/goqu](https://github.com/doug-martin/goqu) - SQL builder and query library for golang
- [pingcap/dumpling](https://github.com/pingcap/dumpling) - Dumpling is a fast, easy-to-use tool written by Go for dumping data from the database(MySQL, TiDB...) to local/cloud(S3, GCP...) in multifarious formats(SQL, CSV...).
- [tora-tool/tora](https://github.com/tora-tool/tora) - TOra is an open source SQL IDE for Oracle, MySQL and PostgreSQL dbs
- [simonw/datasette](https://github.com/simonw/datasette) - An open source multi-tool for exploring and publishing data
- [flyway/flyway](https://github.com/flyway/flyway) - Flyway by Redgate • Database Migrations Made Easy.
- [jly8866/archer](https://github.com/jly8866/archer) - 基于inception的自动化SQL操作平台，支持SQL执行、LDAP认证、发邮件、OSC、SQL查询、SQL优化建议、权限管理等功能，支持docker镜像
- [knex/knex](https://github.com/knex/knex) - A query builder for PostgreSQL, MySQL, CockroachDB, SQL Server, SQLite3 and Oracle, designed to be flexible, portable, and fun to use.
...
- [tox-dev/tox](https://github.com/tox-dev/tox) - Command line driven CI frontend and development task automation tool.
- [ysmood/got](https://github.com/ysmood/got) - An enjoyable golang test framework.
- [hmil/omnimock](https://github.com/hmil/omnimock) - Delicious mocks for TypeScript
- [hoppscotch/hoppscotch](https://github.com/hoppscotch/hoppscotch) - 👽 Open source API development ecosystem - https://hoppscotch.io
- [localstack/localstack](https://github.com/localstack/localstack) - 💻 A fully functional local AWS cloud stack. Develop and test your cloud & Serverless apps offline
- [testjavascript/nodejs-integration-tests-best-practices](https://github.com/testjavascript/nodejs-integration-tests-best-practices) - ✅  Beyond the basics of Node.js testing. Including a super-comprehensive best practices list and an example app (July 2023)
- [microsoft/playwright](https://github.com/microsoft/playwright) - Playwright is a framework for Web Testing and Automation. It allows testing Chromium, Firefox and WebKit with a single API.
...
- [teambit/bit](https://github.com/teambit/bit) - A tool for composable software development.
- [mstfymrtc/flagsmith-vue-client](https://github.com/mstfymrtc/flagsmith-vue-client) - A Vue client for the Flagsmith open-source feature flag platform
...
- [dotnetcore/WTM](https://github.com/dotnetcore/WTM) - Use WTM to write .netcore app fast !!!
- [Advanced-Frontend/Daily-Interview-Question](https://github.com/Advanced-Frontend/Daily-Interview-Question) - 我是依扬（木易杨），公众号「高级前端进阶」作者，每天搞定一道前端大厂面试题，祝大家天天进步，一年后会看到不一样的自己。
- [hql7/wl-gantt](https://github.com/hql7/wl-gantt) - wl-gantt：一个简单易用且高度可配置的甘特图进度计划项目管理插件。An easy-to-use gantt plug-in for the vue framework.
- [hoppscotch/hoppscotch](https://github.com/hoppscotch/hoppscotch) - 👽 Open source API development ecosystem - https://hoppscotch.io
- [Vanessa219/vditor](https://github.com/Vanessa219/vditor) - ♏  一款浏览器端的 Markdown 编辑器，支持所见即所得（富文本）、即时渲染（类似 Typora）和分屏预览模式。An In-browser Markdown editor, support WYSIWYG (Rich Text),  Instant Rendering (Typora-like) and Split View modes.
...
- [vuejs/vuex](https://github.com/vuejs/vuex) - 🗃️ Centralized State Management for Vue.js.
- [nuxt/nuxt](https://github.com/nuxt/nuxt) - Nuxt is an intuitive and extendable way to create type-safe, performant and production-grade full-stack web apps and websites with Vue 3.
- [chshapple/vue-krpano](https://github.com/chshapple/vue-krpano) - A Vue component for krpano player.
- [vuejs/vetur](https://github.com/vuejs/vetur) - Vue tooling for VS Code.
- [NeutroniumCore/Neutronium](https://github.com/NeutroniumCore/Neutronium) - 🚀 Build .NET desktop applications using HTML, CSS and javascript.
...
- [merkle-open/webpack-config-plugins](https://github.com/merkle-open/webpack-config-plugins) - Provide best practices for webpack 4 loader configurations
- [markshapiro/webpack-merge-and-include-globally](https://github.com/markshapiro/webpack-merge-and-include-globally) - Merge multiple files (js, css..) and include by running them "as is". Supports minify by custom transform and wildcard paths.
- [Vonubat/rs-lang](https://github.com/Vonubat/rs-lang) - RS Lang - App for Learning English
...
To the extent possible under law, [yicone](https://github.com/yicone) has waived all copyright and related or neighboring rights to this work.
